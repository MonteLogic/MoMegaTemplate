...
exports.generateAuthPages = generateAuthPages;
const fs_extra_1 = __importDefault(require("fs-extra"));
const path_1 = __importDefault(require("path"));
async function generateAuthPages(config) {
...
export default function SignInPage() {
  return (
    ...
    await fs_extra_1.default.writeFile(path_1.default.join(projectPath, 'app', 'sign-in', 'page.tsx'), signInPageContent);
...
export default function SignUpPage() {
  return (
    ...
    await fs_extra_1.default.writeFile(path_1.default.join(projectPath, 'app', 'sign-up', 'page.tsx'), signUpPageContent);
...
export default async function DashboardPage() {
  ...
  return (
    ...
    await fs_extra_1.default.writeFile(path_1.default.join(projectPath, 'app', 'dashboard', 'page.tsx'), dashboardPageContent);
...
export default async function SettingsPage() {
  ...
  return (
    ...
    await fs_extra_1.default.writeFile(path_1.default.join(projectPath, 'app', 'settings', 'page.tsx'), settingsPageContent);
}
